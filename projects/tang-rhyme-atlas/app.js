...
details.中古="当前 1,000 字核心集采用 Unihan kTang 唐音拟音的标准化韵母作为操作性分类；完整《广韵》韵目将在取得逐字字段后并列保留。";
details.客家话="当前 1,000 字核心集采用客语辞典四县腔，保留 /m n ŋ/ 与 /p t k/ 等韵尾。它只是一个明确采样点，不代表所有客家口音。";
